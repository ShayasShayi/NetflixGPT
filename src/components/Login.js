...
import { APP_BG_IMAGE, USER_IMAGE_AVATAR } from "../utils/constants";
...
const Login =()=>{
    ...
    const createUser= (email,password,displayName)=>{
        ...
        .then((userCredential) => {
            ...
            updateProfile(user, {
                displayName: displayName, photoURL: USER_IMAGE_AVATAR
              }).then(() => {
    ...
    return(
        <div className="flex">
            <img className="absolute" src={APP_BG_IMAGE} alt="BG_IMAGE"/>
            <Header/>
